...
\section{Conclusion}
Ce projet a exploré la reconnaissance des émotions faciales en utilisant 
des points de repères 2D et des modèles de machine learning, notamment les SVM. 
Malgré une précision de 78.06\%, des limitations subsistent, 
notamment en raison des variations interindividuelles et de la perte d'informations telles que les textures et micro-expressions.

Les résultats montrent que les points de repères seuls ne suffisent 
pas pour une reconnaissance d'émotions optimale. Pour des améliorations futures, 
il serait bénéfique d'explorer des approches hybrides intégrant des caractéristiques supplémentaires 
via des modèles d'apprentissage profond comme les CNN et LSTM, 
et de diversifier les données pour mieux capturer les variations faciales.
